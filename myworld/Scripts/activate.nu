...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ASUS\PycharmProjects\learn_w3\myworld'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ASUS\PycharmProjects\learn_w3\myworld\Scripts\deactivate.nu'
